...
- (void)testCalibrationReadsFilterWithDataBeforeAndAfterDate
{
    ...
    SyncData *filteredData = [SyncDataFilter sortAndFilterData:data withSyncTag:[SyncTag initialSyncTag] since:[NSDate dateWithTimeInterval:101 sinceDate:[Types dexcomEpoch]]];
...
- (void)testCalibrationReadsFilterWithDataAllBeforeDate
{
    ...
    [data.calibrationReads addObject:[MeterReadRecord recordWithMeterRead:10 internalSecondsSinceDexcomEpoch:100 localSecondsSinceDexcomEpoch:100 meterTimeInSecondsSinceDexcomEpoch:100 recordNumber:0 pageNumber:0]];
    [data.calibrationReads addObject:[MeterReadRecord recordWithMeterRead:10 internalSecondsSinceDexcomEpoch:1000 localSecondsSinceDexcomEpoch:1000 meterTimeInSecondsSinceDexcomEpoch:1000 recordNumber:0 pageNumber:0]];
    SyncData *filteredData = [SyncDataFilter sortAndFilterData:data withSyncTag:[SyncTag initialSyncTag] since:[NSDate dateWithTimeInterval:1001 sinceDate:[Types dexcomEpoch]]];
...
- (void)testDataSorted
{
    ...
    [data.calibrationReads addObject:[MeterReadRecord recordWithMeterRead:10 internalSecondsSinceDexcomEpoch:100 localSecondsSinceDexcomEpoch:100 meterTimeInSecondsSinceDexcomEpoch:100 recordNumber:0 pageNumber:0]];
    SyncData *filteredData = [SyncDataFilter sortAndFilterData:data withSyncTag:[SyncTag initialSyncTag] since:[NSDate dateWithTimeInterval:99 sinceDate:[Types dexcomEpoch]]];
...
- (void)testCalibrationReadsFilterWithDataExactlyOnDate
{
    ...
    [data.calibrationReads addObject:[MeterReadRecord recordWithMeterRead:10 internalSecondsSinceDexcomEpoch:100 localSecondsSinceDexcomEpoch:100 meterTimeInSecondsSinceDexcomEpoch:100 recordNumber:0 pageNumber:0]];
    [data.calibrationReads addObject:[MeterReadRecord recordWithMeterRead:10 internalSecondsSinceDexcomEpoch:1000 localSecondsSinceDexcomEpoch:1000 meterTimeInSecondsSinceDexcomEpoch:1000 recordNumber:0 pageNumber:0]];
    SyncData *filteredData = [SyncDataFilter sortAndFilterData:data withSyncTag:[SyncTag initialSyncTag] since:[NSDate dateWithTimeInterval:100 sinceDate:[Types dexcomEpoch]]];
    XCTAssertEqual([filteredData.calibrationReads count], 1ul);
}
...
- (void)testCalibrationReadsFilterWithIncrementalSyncTag
{
    ...
    SyncData *filteredData = [SyncDataFilter sortAndFilterData:data withSyncTag:syncTag since:[NSDate dateWithTimeInterval:0 sinceDate:[Types dexcomEpoch]]];
    XCTAssertEqual([filteredData.calibrationReads count], 1ul);
}
