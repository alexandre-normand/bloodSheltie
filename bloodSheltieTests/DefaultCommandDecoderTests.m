...
- (void)testDatabasePageRangeResponseDecoding
{
    ...
    ReceiverResponse *response = [DefaultDecoder decodeResponse:data toRequest:[[ReadDatabasePageRangeRequest alloc] initWithRecordType:UserEventData]];
...
-(void)testDatabasePageOfGlucoseDataDecoding
{
    ...
    ReceiverResponse *response = [DefaultDecoder decodeResponse:data toRequest:[[ReadDatabasePagesRequest alloc] initWithRecordType:EGVData pageNumber:1 numberOfPages:2]];
    XCTAssertNotNil(response, @"response should not be nil for input [%s]", [input UTF8String]);
    XCTAssertNotNil(response.payload, @"response.payload should not be nil for input [%s]", [input UTF8String]);
...
-(void)testTimezoneDecoding
{
    ...
    ReceiverResponse *response = [DefaultDecoder decodeResponse:data toRequest:[[ReadDatabasePagesRequest alloc] initWithRecordType:EGVData pageNumber:304 numberOfPages:2]];
    XCTAssertNotNil(response, @"response should not be nil for input [%s]", [input UTF8String]);
    XCTAssertNotNil(response.payload, @"response.payload should not be nil for input [%s]", [input UTF8String]);
    RecordData *recordData = (RecordData *) response.payload;
    XCTAssertEqual(recordData.recordType, EGVData);
...
-(void)testDatabasePageOfUserEventDecoding
{
    ...
    ReceiverResponse *response = [DefaultDecoder decodeResponse:data toRequest:[[ReadDatabasePagesRequest alloc] initWithRecordType:UserEventData pageNumber:1 numberOfPages:2]];
    XCTAssertNotNil(response, @"response should not be nil for input [%s]", [input UTF8String]);
    XCTAssertNotNil(response.payload, @"response.payload should not be nil for input [%s]", [input UTF8String]);
    RecordData *recordData = (RecordData *) response.payload;
...
-(void)testGlucoseUnitDecoding
{
    ...
    ReceiverResponse *response = [DefaultDecoder decodeResponse:data toRequest:[[ReceiverRequest alloc] initWithCommand:ReadGlucoseUnit]];
    XCTAssertNotNil(response, @"response should not be nil for input [%s]", [input UTF8String]);
    XCTAssertNotNil(response.payload, @"response.payload should not be nil for input [%s]", [input UTF8String]);
...
-(void)testDisplayTimeOffset
{
    ...
    ReceiverResponse *response = [DefaultDecoder decodeResponse:data toRequest:[[ReceiverRequest alloc] initWithCommand:ReadDisplayTimeOffset]];
    XCTAssertNotNil(response, @"response should not be nil for input [%s]", [input UTF8String]);
    XCTAssertNotNil(response.payload, @"response.payload should not be nil for input [%s]", [input UTF8String]);
