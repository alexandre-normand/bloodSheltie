...
- (void)testGlucoseReadConversionWithMgPerDL {
    ...
    [glucoseRecords addObject:[GlucoseReadRecord recordWithRawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 glucoseValue:76 trendArrowAndNoise:0 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:-1800]];
...
- (void)testGlucoseReadTimestamp {
    ...
    [glucoseRecords addObject:[GlucoseReadRecord recordWithRawInternalTimeInSeconds:25200 rawDisplayTimeInSeconds:0 glucoseValue:76 trendArrowAndNoise:0 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
...
- (void)testGlucoseReadConversionWithMmolPerL {
    NSMutableArray *glucoseRecords = [NSMutableArray array];
    [glucoseRecords addObject:[GlucoseReadRecord recordWithRawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 glucoseValue:76 trendArrowAndNoise:0 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
...
- (void)testInsulinInjectionConversion {
    ...
    [injections addObject:[UserEventRecord recordWithEventType:Insulin subType:0 eventValue:325 rawEventTimeInSeconds:1800 rawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
    ...
    NSDate *expectedUserTime = [NSDate dateWithTimeIntervalSince1970:1800];
    NSDate *expectedInternalTime = [NSDate dateWithTimeIntervalSince1970:0];
    NSDate *expectedEventTime = [NSDate dateWithTimeIntervalSince1970:1800];
...
- (void)testExerciseEventConversion {
    ...
    [userEvents addObject:[UserEventRecord recordWithEventType:Exercise subType:Light eventValue:15 rawEventTimeInSeconds:1800 rawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
...
- (void)testFoodEventConversion {
    NSMutableArray *userEvents = [NSMutableArray array];
    [userEvents addObject:[UserEventRecord recordWithEventType:Carbs subType:0 eventValue:15 rawEventTimeInSeconds:1800 rawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
...
- (void)testEventTimestampConversion {
    NSMutableArray *userEvents = [NSMutableArray array];
    [userEvents addObject:[UserEventRecord recordWithEventType:Carbs subType:0 eventValue:15 rawEventTimeInSeconds:4000 rawInternalTimeInSeconds:25200 rawDisplayTimeInSeconds:0 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
    ...
    NSDate *expectedUserTime = [NSDate dateWithTimeIntervalSince1970:0];
    NSDate *expectedInternalTime = [NSDate dateWithTimeIntervalSince1970:25200];
    NSDate *expectedEventTime = [NSDate dateWithTimeIntervalSince1970:4000];
...
- (void)testHealthEventConversion {
    NSMutableArray *userEvents = [NSMutableArray array];
    [userEvents addObject:[UserEventRecord recordWithEventType:Health subType:Stress eventValue:0 rawEventTimeInSeconds:1800 rawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
    ...
    NSDate *expectedInternalTime = [NSDate dateWithTimeIntervalSince1970:0];
    NSDate *expectedEventTime = [NSDate dateWithTimeIntervalSince1970:1800];
    HealthEvent *expectedHealthEvent = [HealthEvent valueWithInternalTime:expectedInternalTime userTime:expectedUserTime userTimezone:[Types timezoneFromLocalTime:expectedUserTime andInternalTime:expectedInternalTime] eventTime:expectedEventTime type:@"Stress" details:nil timestamp:0];
...
- (void)testMeterReadConversionWithMgPerDL {
    ...
    [meterReadRecords addObject:[MeterReadRecord recordWithMeterRead:75 rawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 rawMeterTimeInSeconds:1800 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
    ...
    NSDate *expectedInternalTime = [NSDate dateWithTimeIntervalSince1970:0];
    NSDate *expectedUserTime = [NSDate dateWithTimeIntervalSince1970:1800];
    NSDate *expectedMeterTime = [NSDate dateWithTimeIntervalSince1970:1800];
...
- (void)testMeterReadConversionWithMmolPerL {
    NSMutableArray *meterReadRecords = [NSMutableArray array];
    [meterReadRecords addObject:[MeterReadRecord recordWithMeterRead:47 rawInternalTimeInSeconds:0 rawDisplayTimeInSeconds:1800 rawMeterTimeInSeconds:1800 recordNumber:0 pageNumber:0 dexcomOffsetWithStandardInSeconds:0]];
