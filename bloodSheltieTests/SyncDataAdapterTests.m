...
- (void)testGlucoseReadConversionWithMgPerDL {
    ...
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mgPerDL timeOffsetInSeconds:1800 glucoseReads:glucoseRecords calibrationReads:empty userEvents:empty manufacturingParameters:nil]];
...
- (void)testGlucoseReadTimestamp {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mgPerDL timeOffsetInSeconds:-25200 glucoseReads:glucoseRecords calibrationReads:empty userEvents:empty manufacturingParameters:nil]];
...
- (void)testGlucoseReadConversionWithMmolPerL {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mmolPerL timeOffsetInSeconds:1800 glucoseReads:glucoseRecords calibrationReads:empty userEvents:empty manufacturingParameters:nil]];
...
- (void)testInsulinInjectionConversion {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mgPerDL timeOffsetInSeconds:1800 glucoseReads:empty calibrationReads:empty userEvents:injections manufacturingParameters:nil]];
...
- (void)testExerciseEventConversion {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mgPerDL timeOffsetInSeconds:1800 glucoseReads:empty calibrationReads:empty userEvents:userEvents manufacturingParameters:nil]];
...
- (void)testEventTimestampConversion {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mgPerDL timeOffsetInSeconds:-25200 glucoseReads:empty calibrationReads:empty userEvents:userEvents manufacturingParameters:nil]];
...
- (void)testHealthEventConversion {
    ...
    NSDate *expectedInternalTime = [Types dateTimeFromSecondsSinceDexcomEpoch:0];
    NSDate *expectedEventTime = [Types dateTimeFromSecondsSinceDexcomEpoch:1800];
    HealthEvent *expectedHealthEvent = [HealthEvent valueWithInternalTime:expectedInternalTime userTime:expectedUserTime userTimezone:[Types timezoneFromLocalTime:expectedUserTime andInternalTime:expectedInternalTime] eventTime:expectedEventTime type:@"Stress" details:nil timestamp:1230793200000];
...
- (void)testMeterReadConversionWithMgPerDL {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mgPerDL timeOffsetInSeconds:1800 glucoseReads:empty calibrationReads:meterReadRecords userEvents:empty manufacturingParameters:nil]];
...
- (void)testMeterReadConversionWithMmolPerL {
    ...
    NSMutableArray *empty = [NSMutableArray array];
    SyncData *syncData = [SyncDataAdapter convertSyncData:[InternalSyncData dataWithGlucoseUnit:mmolPerL timeOffsetInSeconds:1800 glucoseReads:empty calibrationReads:meterReadRecords userEvents:empty manufacturingParameters:nil]];
